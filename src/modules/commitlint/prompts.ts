...
const llmReadableRules: {
  ...
  caseRule: (key, applicable, value: unknown) =>
  ...
  enumRule: (key, applicable, value: unknown) =>
    `The ${key} should ${applicable} be one of the following values: 
  - ${Array.isArray(value) ? value.join('\n  - ') : value}.`,
  enumTypeRule: (key, applicable, value: unknown, prompt) =>
    `The ${key} should ${applicable} be one of the following values: 
  - ${
    Array.isArray(value)
      ? value
  ...
  fullStopRule: (key, applicable, value: unknown) =>
    `The ${key} should ${applicable} end with '${value}'.`,
  maxLengthRule: (key, applicable, value: unknown) =>
    `The ${key} should ${applicable} have ${value} characters or less.`,
  minLengthRule: (key, applicable, value: unknown) =>
...
const rulesPrompts: {
  ...
  'body-case': (applicable: string, value: unknown) =>
  ...
  'body-full-stop': (applicable: string, value: unknown) =>
  ...
  'body-max-length': (applicable: string, value: unknown) =>
    llmReadableRules.maxLengthRule('body', applicable, value),
  'body-max-line-length': (applicable: string, value: unknown) =>
    `Each line of the body should ${applicable} have ${value} characters or less.`,
  'body-min-length': (applicable: string, value: unknown) =>
    llmReadableRules.minLengthRule('body', applicable, value),
  'footer-case': (applicable: string, value: unknown) =>
  ...
  'footer-max-length': (applicable: string, value: unknown) =>
    llmReadableRules.maxLengthRule('footer', applicable, value),
  'footer-max-line-length': (applicable: string, value: unknown) =>
    `Each line of the footer should ${applicable} have ${value} characters or less.`,
  'footer-min-length': (applicable: string, value: unknown) =>
    llmReadableRules.minLengthRule('footer', applicable, value),
  'header-case': (applicable: string, value: unknown) =>
    llmReadableRules.caseRule('header', applicable, value),
  'header-full-stop': (applicable: string, value: unknown) =>
    llmReadableRules.fullStopRule('header', applicable, value),
  'header-max-length': (applicable: string, value: unknown) =>
    llmReadableRules.maxLengthRule('header', applicable, value),
  'header-min-length': (applicable: string, value: unknown) =>
  ...
  'scope-case': (applicable: string, value: unknown) =>
  ...
  'subject-full-stop': (applicable: string, value: unknown) =>
    llmReadableRules.fullStopRule('subject', applicable, value),
  'subject-max-length': (applicable: string, value: unknown) =>
    llmReadableRules.maxLengthRule('subject', applicable, value),
  'subject-min-length': (applicable: string, value: unknown) =>
    llmReadableRules.minLengthRule('subject', applicable, value),
  'type-case': (applicable: string, value: unknown) =>
  ...
  'type-enum': (applicable: string, value: unknown, prompt) =>
    llmReadableRules.enumTypeRule('type', applicable, value, prompt),
  'type-max-length': (applicable: string, value: unknown) =>
    llmReadableRules.maxLengthRule('type', applicable, value),
  'type-min-length': (applicable: string, value: unknown) =>
...
export const inferPromptsFromCommitlintConfig = (
  config: Partial<QualifiedConfig>,
): string[] => {
  ...
  return Object.keys(rules)
    .map(ruleName =>
      getPrompt(
        ruleName,
        rules[ruleName] as RuleConfigTuple<unknown>,
        prompt || {},
      ),
    )
...
export function getCommitlintPrompts() {
